using TYProject.Core.Interfaces;
using TYProject.Core.ProjectAggregate;
using TYProject.Core.ProjectAggregate.Events;
using TYProject.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace TYProject.UnitTests.Core.Handlers;
